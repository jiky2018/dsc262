...
<div class="main">
  <div class="step-box" id="step2">
    ...
    <div class="procedure-nav">
      <div class="schedule-ico"><span class="a"></span><span class="b"></span><span class="c"></span></div>
      <div class="schedule-point-now"><span class="a"></span><span class="b"></span><span class="c"></span></div>
      <div class="schedule-point-bg"><span class="a"></span><span class="b"></span><span class="c"></span></div>
      <div class="schedule-line-now"><em></em></div>
      <div class="schedule-line-bg"></div>
      <div class="schedule-text"><span class="a">检查安装环境</span><span class="b">创建数据库</span><span class="c">安装</span></div>
    </div>
  </div>
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="100" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'picture';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
          <input type="text" name="db_user" maxlength="100" value="<?php echo $_POST['db_user'] ? $_POST['db_user'] : '';?>">
          </span> <em></em></div>
        <div>
          <label>数据库密码</label>
          <span>
          <input type="password" name="db_pwd" maxlength="100" value="<?php echo $_POST['db_pwd'] ? $_POST['db_pwd'] : '';?>">
          </span> <em></em></div>
        <div>
          <label>数据库端口</label>
          <span>
	  ...
	  <div>
          <label>淘宝订单号</label>
          <span>
          <input type="text" name="sq" maxlength="20" value="<?php echo $_POST['sq'] ? $_POST['sq'] : '';?>">
          </span></div>
      ...
      <fieldset>
        ...
        <div>
          <label>管理员账号</label>
          <span style="line-height:40px;">admin</span></div>
        <div>
          <label>管理员密码</label>
          <span>
          <span style="line-height:40px;">admin2018</span></div>
      </fieldset>
    </div>
