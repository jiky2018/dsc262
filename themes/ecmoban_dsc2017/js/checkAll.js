...
$(function(){
	...
	//参加同一个优惠活动切换勾选时判断
	function replace_cart_goods(rec_id, favourable_id, $this,ru_id)
	{
		var ajax_where = '';
		var select_flag = '';
		var str ='';
		...
		Ajax.call('flow.php?step=ajax_cart_goods_amount', 'rec_id=' + rec_id + '&ru_id=' + ru_id + select_flag + ajax_where, replace_cart_goods_response, 'POST','JSON');                
	}
